...
router.get('/admin/prices',ensureAuthenticated, function (req, res) {
...
router.get('/admin/customers',ensureAuthenticated, function (req, res,next) {
...
router.get('/admin/register',ensureAuthenticated, function (req, res) {
